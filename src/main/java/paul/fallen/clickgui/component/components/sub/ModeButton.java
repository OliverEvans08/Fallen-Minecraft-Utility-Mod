...
public class ModeButton extends Component {
	...
	public void renderComponent() {
		UIUtils.drawRect(parent.parent.getX() + 1, parent.parent.getY() + offset, (parent.parent.getWidth()), 12, this.hovered ? new Color(20, 20, 20, 191).getRGB() : new Color(0, 0, 0, 191).getRGB());
		...
		UIUtils.drawTextOnScreen(set.getName() + ": " + set.getValString(), (parent.parent.getX() + 6), (parent.parent.getY() + offset) + 3, new Color(255, 255, 255, 255).getRGB());
