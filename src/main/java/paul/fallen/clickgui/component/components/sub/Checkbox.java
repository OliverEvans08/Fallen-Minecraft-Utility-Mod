...
public class Checkbox extends Component {
	...
	public void renderComponent() {
		...
		UIUtils.drawRect(parent.parent.getX() + 1 + 5, parent.parent.getY() + offset + 3, 9, 9,  new Color(89, 89, 89, 191).getRGB());
		...
		UIUtils.drawTextOnScreen(this.op.getName(), (parent.parent.getX()) + 17, (parent.parent.getY() + offset + 2) + 1, new Color(255, 255, 255, 255).getRGB());
		...
		if (this.op.getValBoolean()) {
			UIUtils.drawRect(parent.parent.getX() + 1 + 5, parent.parent.getY() + offset + 3, 9, 9,  new Color(255, 0, 255, 191).getRGB());
